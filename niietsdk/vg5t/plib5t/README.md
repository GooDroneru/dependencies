...
*PLIB5T (Peripheral Library for K1921VG5T)* - это библиотека периферии на языке C, предназначеная для
ускорения и упрощения работы со внутренними периферийными устройствами микроконтроллера К1921ВГ5Т производства АО "НИИЭТ".
