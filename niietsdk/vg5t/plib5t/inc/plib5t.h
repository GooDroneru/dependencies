/**
  ...
  * @file    plib5t.h
  *
  * @brief   Низкоуровневая библиотека периферии для микроконтроллера НИИЭТ К1921ВГ5Т
  *          Этот файл содержит:
...
/** @addtogroup Plib5t Библиотека периферии
  * @{
  */
...
#include "plib5t_assert.h"
#include "plib5t_version.h"
