...
#ifndef __PLIB5T_SPI_H
#define __PLIB5T_SPI_H
...
/**
  ...
  */
typedef enum {
    SPI_FrameFormat_SPI = SPI_CR_FRF_SPI,             /*!< Режим SPI от Motorola */
    SPI_FrameFormat_SSI = SPI_CR_FRF_SSI,             /*!< Режим SSI от Texas Instruments */
    SPI_FrameFormat_Microwire = SPI_CR_FRF_Microwire, /*!< Режим Microwire от National Semiconductor */
...
/**
  ...
  */
typedef enum {
    SPI_DataWidth_4 = SPI_CR_DSS_4bit,   /*!< Длина информационного слова 4 бит */
    SPI_DataWidth_5 = SPI_CR_DSS_5bit,   /*!< Длина информационного слова 5 бит */
    SPI_DataWidth_6 = SPI_CR_DSS_6bit,   /*!< Длина информационного слова 6 бит */
    SPI_DataWidth_7 = SPI_CR_DSS_7bit,   /*!< Длина информационного слова 7 бит */
    SPI_DataWidth_8 = SPI_CR_DSS_8bit,   /*!< Длина информационного слова 8 бит */
    SPI_DataWidth_9 = SPI_CR_DSS_9bit,   /*!< Длина информационного слова 9 бит */
    SPI_DataWidth_10 = SPI_CR_DSS_10bit, /*!< Длина информационного слова 10 бит */
    SPI_DataWidth_11 = SPI_CR_DSS_11bit, /*!< Длина информационного слова 11 бит */
    SPI_DataWidth_12 = SPI_CR_DSS_12bit, /*!< Длина информационного слова 12 бит */
    SPI_DataWidth_13 = SPI_CR_DSS_13bit, /*!< Длина информационного слова 13 бит */
    SPI_DataWidth_14 = SPI_CR_DSS_14bit, /*!< Длина информационного слова 14 бит */
    SPI_DataWidth_15 = SPI_CR_DSS_15bit, /*!< Длина информационного слова 15 бит */
    SPI_DataWidth_16 = SPI_CR_DSS_16bit, /*!< Длина информационного слова 16 бит */
	SPI_DataWidth_17 = SPI_CR_DSS_17bit, /*!< Длина информационного слова 17 бит */
    SPI_DataWidth_18 = SPI_CR_DSS_18bit, /*!< Длина информационного слова 18 бит */
    SPI_DataWidth_19 = SPI_CR_DSS_19bit, /*!< Длина информационного слова 19 бит */
    SPI_DataWidth_20 = SPI_CR_DSS_20bit, /*!< Длина информационного слова 20 бит */
    SPI_DataWidth_21 = SPI_CR_DSS_21bit, /*!< Длина информационного слова 21 бит */
    SPI_DataWidth_22 = SPI_CR_DSS_22bit, /*!< Длина информационного слова 22 бит */
    SPI_DataWidth_23 = SPI_CR_DSS_23bit, /*!< Длина информационного слова 23 бит */
    SPI_DataWidth_24 = SPI_CR_DSS_24bit, /*!< Длина информационного слова 24 бит */
    SPI_DataWidth_25 = SPI_CR_DSS_25bit, /*!< Длина информационного слова 25 бит */
    SPI_DataWidth_26 = SPI_CR_DSS_26bit, /*!< Длина информационного слова 26 бит */
	SPI_DataWidth_27 = SPI_CR_DSS_27bit, /*!< Длина информационного слова 27 бит */
    SPI_DataWidth_28 = SPI_CR_DSS_28bit, /*!< Длина информационного слова 28 бит */
    SPI_DataWidth_29 = SPI_CR_DSS_29bit, /*!< Длина информационного слова 29 бит */
    SPI_DataWidth_30 = SPI_CR_DSS_30bit, /*!< Длина информационного слова 30 бит */
    SPI_DataWidth_31 = SPI_CR_DSS_31bit, /*!< Длина информационного слова 31 бит */
    SPI_DataWidth_32 = SPI_CR_DSS_32bit, /*!< Длина информационного слова 32 бит */
...
#define IS_SPI_DATA_WIDTH(VALUE) (((VALUE) == SPI_DataWidth_4) ||  \
                                  ...
                                  ((VALUE) == SPI_DataWidth_17) || \
                                  ((VALUE) == SPI_DataWidth_18) || \
                                  ((VALUE) == SPI_DataWidth_19) || \
                                  ((VALUE) == SPI_DataWidth_20) || \
                                  ((VALUE) == SPI_DataWidth_21) || \
                                  ((VALUE) == SPI_DataWidth_22) || \
                                  ((VALUE) == SPI_DataWidth_23) || \
                                  ((VALUE) == SPI_DataWidth_24) || \
                                  ((VALUE) == SPI_DataWidth_25) || \
                                  ((VALUE) == SPI_DataWidth_26) || \
                                  ((VALUE) == SPI_DataWidth_27) || \
                                  ((VALUE) == SPI_DataWidth_28) || \
                                  ((VALUE) == SPI_DataWidth_29) || \
                                  ((VALUE) == SPI_DataWidth_30) || \
                                  ((VALUE) == SPI_DataWidth_31) || \
                                  ((VALUE) == SPI_DataWidth_32))
...
__STATIC_INLINE void SPI_Cmd(SPI_TypeDef* SPIx, FunctionalState State)
{
    ...
    WRITE_REG(SPIx->CR_bit.SSE, State);
}
...
__STATIC_INLINE void SPI_SlaveOutputDisCmd(SPI_TypeDef* SPIx, FunctionalState State)
{
    ...
    WRITE_REG(SPIx->CR_bit.SOD, State);
}
...
__STATIC_INLINE void SPI_SCKConfig(SPI_TypeDef* SPIx, SPI_SCKPhase_TypeDef SCKPhase, SPI_SCKPolarity_TypeDef SCKPolarity)
{
    ...
    MODIFY_REG(SPIx->CR, SPI_CR_SPH_Msk | SPI_CR_SPO_Msk,
               ((SCKPhase << SPI_CR_SPH_Pos) |
                (SCKPolarity << SPI_CR_SPO_Pos)));
}
...
__STATIC_INLINE void SPI_DataWidthConfig(SPI_TypeDef* SPIx, SPI_DataWidth_TypeDef DataWidth)
{
    ...
    WRITE_REG(SPIx->CR_bit.DSS, DataWidth);
}
...
__STATIC_INLINE void SPI_FrameFormatConfig(SPI_TypeDef* SPIx, SPI_FrameFormat_TypeDef FrameFormat)
{
    ...
    WRITE_REG(SPIx->CR_bit.FRF, FrameFormat);
}
...
__STATIC_INLINE void SPI_SCKDivConfig(SPI_TypeDef* SPIx, uint32_t SCKDiv, uint32_t SCKDivExtra)
{
    ...
    WRITE_REG(SPIx->CR_bit.SCR, SCKDiv);
...
__STATIC_INLINE void SPI_ITFIFOLevelRxConfig(SPI_TypeDef* SPIx, uint32_t FIFOLevelRx)
{
    ...
    WRITE_REG(SPIx->CR_bit.RXIFLSEL, FIFOLevelRx);
}
...
__STATIC_INLINE void SPI_ITFIFOLevelTxConfig(SPI_TypeDef* SPIx, uint32_t FIFOLevelTx)
{
    ...
    WRITE_REG(SPIx->CR_bit.TXIFLSEL, FIFOLevelTx);
}
