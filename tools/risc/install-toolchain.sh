#!/usr/bin/env bash
# Downloads and installs xPack GNU RISC-V Embedded GCC v15.2.0-1 for Linux x64.
#
# Usage:
...
VERSION="15.2.0-1"
ASSET="xpack-riscv-none-elf-gcc-${VERSION}-linux-x64.tar.gz"
...
TOOLCHAIN_DIR="${INSTALL_DIR}/xpack-riscv-none-elf-gcc-${VERSION}"
...
echo "xPack RISC-V GCC installer"
...
# --- Summary -----------------------------------------------------------------
GCC_BIN="${TOOLCHAIN_DIR}/bin/riscv-none-elf-gcc"
if [[ -x "${GCC_BIN}" ]]; then
